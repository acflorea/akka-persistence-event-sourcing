...
import akka.actor._
import org.kepteasy.domain.UserAggregate
import org.kepteasy.service.{UserAggregateManager, AggregateManager}
...
trait UserRoute extends HttpService with Json4sSupport
  with RequestHandlerCreator with UserAuthenticator {
